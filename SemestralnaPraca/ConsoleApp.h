...
private:
	HandleInplut<UzemnaJednotka>* input;
	HandlePredicate<UzemnaJednotka>* predicate;
	Filter<UzemnaJednotka>* filter;
};

ConsoleApp::ConsoleApp()
{
	this->input = new HandleInplut<UzemnaJednotka>();
	this->predicate = new HandlePredicate<UzemnaJednotka>();
	this->filter = new Filter<UzemnaJednotka>();
